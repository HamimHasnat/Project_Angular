...
import { AppointmentServiceAngularComponentComponent } from './appointment-service-angular-component/appointment-service-angular-component.component';
...
@NgModule({
  declarations: [
    ...
    AppointmentServiceAngularComponentComponent,
